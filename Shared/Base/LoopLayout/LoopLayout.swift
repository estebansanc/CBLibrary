...
class LoopLayout: UICollectionViewLayout {
    ...
    private let itemXSpacing: CGFloat = 10.0
    ...
    private var arcRadius: CGFloat = UIScreen.main.bounds.width // Radius of the circle that the cells will arc over.
    ...
    private func commonInit() {
        notificationCenter.addObserver(self,
                                       selector: #selector(LoopLayout.accessibilityDidChange),
